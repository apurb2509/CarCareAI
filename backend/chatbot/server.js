...
app.post('/api/chat', async (req, res) => {
  try {
    ...
    const promptTemplate = PromptTemplate.fromTemplate(`
      ...
      - Don't generate too long answers; keep it to the point, concise and precise to what the user is asking. Use as many less sentences as you can. Maximum use 5 sentences only, only if needed. Thus, generate the precise and relevant answer to the question as shorter as possible, but keep all information asked by the user.
